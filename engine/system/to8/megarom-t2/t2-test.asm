...
********************************************************************************
        ...
        lda   #2                            ; page video
        sta   CF74021.DATA                  ; selection de la page en RAM Donnees (A000-DFFF)        
        ...
        ldd   #$0444
        stb   EF9369.D                      ; positionne la nouvelle couleur (Vert et Rouge)
        sta   EF9369.D                      ; positionne la nouvelle couleur (Bleu)        
        ...
        lda   #$80
        sta   CF74021.SYS2                  ; affiche la page 2 a l'ecran        
...
RL_DKContinue                            
        ...
        ldx   <DK.BUF                       ; chargement de la zone a ecrire DK.BUF
...
WR_Continue
        ...
        lda   #$08
        sta   <DK.OPC                       ; DK.OPC $08 Operation - ecriture d'un secteur
WR_DKCO
        jsr   DKCO                          ; DKCO Appel Moniteur - ecriture d'un secteur
        inc   <DK.SEC                       ; increment du registre Moniteur DK.SEC
        lda   <DK.SEC                       ; chargement de DK.SEC
        cmpa  #$10                          ; si DK.SEC est inferieur ou egal a 16
...
DisplayProgress
        ldb   #2                            ; page video
        stb   CF74021.DATA                  ; selection de la page en RAM Donnees (A000-DFFF)        
