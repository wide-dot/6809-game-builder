...
********************************************************************************
        ...
        stb   CF74021.CART             ; changement page 4 dans l'espace cartouche        
...
DKLecture
        ...
        ldd   #$0000
        std   <DK.BUF                  ; DK.BUF $0000 Destination des donnees lues
        sta   <DK.DRV                  ; DK.DRV $00 Lecteur
        std   <DK.TRK                  ; DK.TRK $00 Piste
        lda   #$02
...
***********************************************************
        ...
        stb   CF74021.DATA             ; visible dans l'espace donnees
