...
* ----------------------------------
*   CF74021.SYS2 determine la page affichee a l'ecran
...
* -----------------------------------------
*   MC6846.PRC determine la demi-page de la page 0 visible dans l'espace ecran
*   bit0=0 : 8Ko RAMA
*   bit0=1 : 8ko RAMB
*
...
* ----------------------
* lda   #$04
* sta   CF74021.DATA             ; selection de la page 04 en RAM Donnees (A000-DFFF)
*
********************************************************************************
WaitVBL
        ldd   Vint_runcount
...
glb_screen_border_color        
        ...
        stb   CF74021.SYS2       ; changement page (2 ou 3) affichee a l'ecran
...
am_SwapVideoPage
        ...
        orb   #$02               ; bit1=1
        stb   CF74021.DATA       ; changement page (2 ou 3) visible dans l'espace donnees
        ldb   MC6846.PRC         ; charge l'identifiant de la demi-page 0 configuree en espace ecran
