...
; Interleave table
* the media's reading order, generated by the builder (gen/directories/
* locations.asm, from the storage's <interleave>) : the same table as the
* loader's sclist. Track 0 only here, whose skew is zero.
        INCLUDE "gen/directories/locations.asm"
blist   _loader.interleave.sclist
