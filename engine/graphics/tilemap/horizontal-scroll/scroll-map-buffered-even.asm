...
* ---------------------------------------------------------------------------
        ...
        ;SETDP   dp/256 ; V2-DEVIATION: setdp neutralized (not permitted in lwasm obj target ; the loader now sets DP to the engine page, so the forced '<' accesses below reach it and implicit-direct operands assemble extended)
