...
; user stack. The v2 IRQ manager switches S to its own buffer in its first
; instruction, leaving only the hardware push (12 bytes) ; v1's extra 4 bytes
; covered calls made before that switch.
        subd  #12
