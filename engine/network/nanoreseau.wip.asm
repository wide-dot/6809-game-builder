...
;*
;* !!!!! WARNING !!!!!
;* WORK IN PROGESS - NOT WORKING
;* This library will handle data exchange between Thomson computers
;* with the use of the nanoreseau extension (motorola-MC6854)
;* but without the need of a server
;*----------------------------------------------------------------------------*
