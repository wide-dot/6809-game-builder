...
; V2-DEVIATION: l'INCLUDE de ./engine/macros.asm est retire. En v1 chaque objet
; etait une unite d'assemblage a lui seul et devait donc embarquer ses en-tetes ;
; en v2 ce fichier est replie dans l'unite residente, qui les a deja — le
; re-inclure donne « Duplicate macro definition ».
; fade.equ, lui, reste : il est garde par IFNDEF, donc idempotent.
