...
Witnesses at GLOBAL_VARIABLES+13 = $9E4D (src/common/bench.const.asm):
magic $CA, stage, frame counter, camera (word), spawns (word), then
t1..t5 at $9E54..$9E58 — [1,1,1,1,1] is the 5/5 pass. The scenario runs
