...
import com.widedot.m6809.oldgamebuilder.to8.MainProg;
import com.widedot.m6809.oldgamebuilder.to8.audio.Sound;
import com.widedot.m6809.oldgamebuilder.to8.audio.SoundBin;
import com.widedot.m6809.oldgamebuilder.to8.boot.Bootloader;
import com.widedot.m6809.oldgamebuilder.to8.compiledsprite.backupdrawerase.AssemblyGenerator;
import com.widedot.m6809.oldgamebuilder.to8.compiledsprite.draw.SimpleAssemblyGenerator;
import com.widedot.m6809.oldgamebuilder.to8.image.Animation;
import com.widedot.m6809.oldgamebuilder.to8.image.AnimationBin;
import com.widedot.m6809.oldgamebuilder.to8.image.ImageSetBin;
import com.widedot.m6809.oldgamebuilder.to8.image.PaletteTO8;
import com.widedot.m6809.oldgamebuilder.to8.image.PngToBottomUpB16Bin;
import com.widedot.m6809.oldgamebuilder.to8.image.Sprite;
import com.widedot.m6809.oldgamebuilder.to8.image.SpriteSheet;
import com.widedot.m6809.oldgamebuilder.to8.image.SubSprite;
import com.widedot.m6809.oldgamebuilder.to8.image.SubSpriteBin;
import com.widedot.m6809.oldgamebuilder.to8.image.TileBin;
import com.widedot.m6809.oldgamebuilder.to8.image.Tileset;
import com.widedot.m6809.oldgamebuilder.to8.image.encoder.Encoder;
import com.widedot.m6809.oldgamebuilder.to8.image.encoder.MapRleEncoder;
import com.widedot.m6809.oldgamebuilder.to8.image.encoder.ZX0Encoder;
import com.widedot.m6809.oldgamebuilder.to8.knapsack.Item;
import com.widedot.m6809.oldgamebuilder.to8.knapsack.Knapsack;
import com.widedot.m6809.oldgamebuilder.to8.knapsack.Solution;
import com.widedot.m6809.oldgamebuilder.to8.ram.RamImage;
import com.widedot.m6809.oldgamebuilder.to8.storage.DataIndex;
import com.widedot.m6809.oldgamebuilder.to8.storage.FdUtil;
import com.widedot.m6809.oldgamebuilder.to8.storage.RAMLoaderIndex;
import com.widedot.m6809.oldgamebuilder.to8.storage.SdUtil;
import com.widedot.m6809.oldgamebuilder.to8.storage.T2Util;
...
//						logger.debug(SimpleAssemblyGenerator.debug80Col(tileset.tiles.get(s).pixels));						
	...
	private static void compileMainEngines(int mode, boolean writeIdx) throws Throwable {
		...
		for(Entry<String, GameMode> gameMode : MainProg.game.gameModes.entrySet()) {
			...
			AssemblyCompiler.compileRAW(mainEngineTmpFile, mode, gameMode.getValue(), 1);
	...
	public static void compileAndWriteBootFd() throws Exception {
		...
		if (!abortFloppyDisk) {		
			...
			if (MainProg.game.hxcfe != null) {
				logger.debug("\tconvert fd to hfe ...");
				List<String> command = new ArrayList<String>(List.of(
						MainProg.game.hxcfe,
						"-finput:"+MainProg.game.outputDiskName+".fd",
						"-conv:HXC_HFE",
						"-foutput:"+MainProg.game.outputDiskName+".hfe"			   
						));
	...
	public static void buildT2Flash() throws Exception {
		logger.info("Build T2 Loader for SDDRIVE ...");
		
		String tmpFile = duplicateFile(MainProg.game.engineAsmBootT2Flash);
		...
		tmpFile = duplicateFilePrepend(MainProg.game.engineAsmT2Flash, "", prepend);
		AssemblyCompiler.compileRAW(tmpFile, MEGAROM_T2);
