...
public class IncludeBinPlugin {
	public static File getFile(ImmutableNode node, BuildContext ctx) throws Exception {
		...
		String filename = ctx.path + File.separator + ctx.settings.get("generate.unnamedFiles.dir") + File.separator + String.valueOf(java.lang.System.nanoTime()) + ".asm";
