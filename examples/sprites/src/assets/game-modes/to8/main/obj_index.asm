...
* hand. The pages come from the attributed-place equates entries.asm
* publishes, and the imageset symbols are baked by the builder against the
* files' fixed places. Entry 0 is the reserved "free slot" id.
...
Img_Page_Index
        ...
        fcb   map.RAM_OVER_CART+assets.sprites.page   ; id 1 : the bench sprite
        fcb   map.RAM_OVER_CART+assets.sprites.page   ; id 2 : the compressed sprite
...
Ani_Page_Index
        fcb   $00
        fcb   map.RAM_OVER_CART+assets.sprites.page
        fcb   map.RAM_OVER_CART+assets.sprites.page
