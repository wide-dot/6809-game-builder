...
vgc.buffers   EXTERNAL ; 256*8 bytes buffer should be user defined
                       ; and memory aligned to 256 bytes
vgc.play       EXPORT
vgc.obj.play   EXPORT
vgc.frame.play EXPORT

        INCLUDE "new-engine/sound/sn76489.macro.asm"
...
vgc.finished    fcb 0    ; a flag to indicate player has reached the end of the vgc stream
vgc.loop        fcb 0    ; non zero if tune is to be looped
