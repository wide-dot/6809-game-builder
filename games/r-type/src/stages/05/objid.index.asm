...
Obj_Index_Page
        ...
        fcb   map.RAM_OVER_CART+stage5.cast.page ; ObjID_slither_render_hit
...
Obj_Index_Address
        ...
        fdb   slither.Render ; ObjID_slither_render_hit
...
Ani_Asd_Index
        ...
        fdb   Ani_Asd_none ; ObjID_slither_render_hit
...
Img_Page_Index
        ...
        fcb   map.RAM_OVER_CART+stage5.cast.imgBodyHit.page ; ObjID_slither_render_hit
