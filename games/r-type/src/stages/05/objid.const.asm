...
ObjID_slither equ 38
ObjID_slither_head equ 39
ObjID_slither_tail equ 40
ObjID_slither_render equ 41
...
ObjID_slither_tail_corpse equ 43
...
ObjID_slither_head_hit equ 44
* Et la QUEUE pendant son flash, pour la meme raison.
ObjID_slither_tail_hit equ 45
objid.count equ 45
