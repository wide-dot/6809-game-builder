...
* Le MANAGER des gerbes : un seul identifiant pour les trois orientations.
* Les trente poses ne tenaient pas dans une page — la deduplication de la
* chaine arcade (quatre poses uniques sur dix pas) les y fait tenir, et
* Img_Page_Index de cet identifiant EST cette page : celle des descripteurs
* que wsmgr monte pour dessiner les tranches (l'objet, lui, vit dans le cast
* depuis le 09/09/2026). Il ne se lance pas depuis un script : le premier
* armement le fait naitre. Voir enemies/warship-elements/reactor/flamemgr.asm.
ObjID_warship_flamemgr equ 43
* Le MANAGER des pieces mobiles (09/09/2026) : un objet resident, sans image a
* lui, qui dessine par tranches de 16x12, au fond, les GROS sprites mobiles
* qui s'inscrivent chez lui (wsmgr.Draw) : reacteur arriere, allumage et
