...
Obj_Index_Page
        ...
        fcb   map.RAM_OVER_CART+stage3.page ; ObjID_commonmissile
        ...
        fcb   map.RAM_OVER_CART+stage3.page ; ObjID_collision
        ...
        fcb   map.RAM_OVER_CART+stage3.page ; ObjID_initlevel1
        ...
        fcb   map.RAM_OVER_CART+stage3.page ; ObjID_endstage
        ...
        fcb   map.RAM_OVER_CART+stage3.page ; ObjID_scantfire
        fcb   map.RAM_OVER_CART+stage3.page ; ObjID_tabrokcanon
        fcb   map.RAM_OVER_CART+stage3.page ; ObjID_shellEraser
        fcb   map.RAM_OVER_CART+stage3.page ; ObjID_commonmissileflame
        fcb   map.RAM_OVER_CART+stage3.page ; ObjID_dobkeratops_saw
        fcb   map.RAM_OVER_CART+stage3.page ; ObjID_dobkeratops_explosion
        fcb   map.RAM_OVER_CART+common.pow.page ; ObjID_pow
        fcb   map.RAM_OVER_CART+stage3.page ; ObjID_checkpoint
        fcb   map.RAM_OVER_CART+stage3.page ; ObjID_bossmusic
