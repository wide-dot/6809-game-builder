;*******************************************************************************
; Stage 4 — mis en place avec sa carte (chantier stages 3-8)
;
...
sounds.level4.ymm EXTERNAL
sounds.boss.ymm   EXTERNAL
sounds.clearstage.ymm EXTERNAL
stage.music       equ sounds.level4.ymm
stage.music.page  equ stage4.music.ymm.page
...
; checkpoint ($0A80,ObjID_checkpoint dans wave.asm) et sa position est son
...
stage.setup
        ...
        lda   #map.RAM_OVER_CART+stage4.wave.page
...
; Fin du stage 4 : on enchaîne sur le stage 5. La campagne remonte
...
;*******************************************************************************
        ...
        INCLUDE "src/stages/04/objid.index.asm"
