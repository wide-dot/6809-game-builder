;*******************************************************************************
; Stage 6 — mis en place avec sa carte (chantier stages 3-8)
;
...
emitterFlash.Object EXTERNAL
 ...
 SECTION code
        ...
        INCLUDE "gen/stages/06/map/map.const.asm"
...
stage.setup
        ...
        ldd   #map.odd
        std   scroll_map_odd
        lda   #map.RAM_OVER_CART+stage6.maps.page
...
stage.handOver
        ...
        ldx   #scenes.stage7
        ldy   #scenes.stage7.dir
        ldu   #cast.stage7                  ; les lots d'ennemis de la cible
        jmp   game.stage.switch

;*******************************************************************************
; L'index d'objets et la wave — les données réelles du niveau 2
;*******************************************************************************
        INCLUDE "src/stages/06/objid.const.asm"
        INCLUDE "src/stages/06/objid.index.asm"
