* Object index of stage 6 — hand-maintained since the <objectindex>
...
Obj_Index_Page
        ...
        fcb   map.RAM_OVER_CART+stage6.page ; ObjID_commonmissile
        ...
        fcb   map.RAM_OVER_CART+stage6.page ; ObjID_collision
        ...
        fcb   map.RAM_OVER_CART+stage6.page ; ObjID_scantfire
        fcb   map.RAM_OVER_CART+stage6.page ; ObjID_tabrokcanon
        fcb   map.RAM_OVER_CART+stage6.page ; ObjID_shellEraser
        fcb   map.RAM_OVER_CART+stage6.page ; ObjID_commonmissileflame
        fcb   map.RAM_OVER_CART+stage6.page ; ObjID_dobkeratops_saw
...
Ani_Page_Index
        fcb   map.RAM_OVER_CART+stage6.page
        fcb   map.RAM_OVER_CART+common.anim.page ; ObjID_animation
        fcb   map.RAM_OVER_CART+common.explosion.page ; ObjID_explosion
        fcb   map.RAM_OVER_CART+common.fade.page ; ObjID_fade
        fcb   map.RAM_OVER_CART+common.player.page ; ObjID_Player1
