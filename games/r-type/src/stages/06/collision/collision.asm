;*******************************************************************************
; La collision terrain du stage 6 — unite paginee, gabarit du stage 1
;
...
; (vérité : le terrain.asm v1 du stage, dans src/stages/06/terrain/).
;
...
lvlMapWidth equ 48 ; stage 06 width (terrain.asm v1)
...
; level6_bc.bin du dossier terrain est un orphelin qu'elle ne
; consomme jamais (son pas de ligne ne correspond d'ailleurs pas).
collisionMapBackground
collisionMapForeground
        INCLUDEBIN "src/stages/06/terrain/level6_fc.bin"
