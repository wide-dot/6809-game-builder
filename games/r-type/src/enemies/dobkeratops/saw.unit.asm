;*******************************************************************************
; dobkeratops_saw — la scie que le monstre crache, portee de la v1
;
; Projectile indestructible (liste ennemie non tuable) : il traverse l'ecran
; et sort.
;
...
;*******************************************************************************
dobkeratopsSaw.Object   EXPORT

        INCLUDE "src/common/engine/api.asm"

; L'index d'objets du stage charge : la scie y lit ce qu'elle fait naitre.
...
Img_dobkeratops_saw_0            equ set_dobkeratops_saw_0
Img_dobkeratops_saw_1            equ set_dobkeratops_saw_1
Img_dobkeratops_saw_2            equ set_dobkeratops_saw_2
Img_dobkeratops_saw_3            equ set_dobkeratops_saw_3

; V2-DEVIATION : l'entree v1 s'appelle `Object`, un nom trop generique pour la
; frontiere de lien.
dobkeratopsSaw.Object
        INCLUDE "src/enemies/dobkeratops/saw.asm"
