...
;
; La direntry est `bake="all"` : ces ~2900 pointeurs se renvoient les uns aux
; autres, et le builder sait où l'unité est chargée, donc il résout tout au
; build. Sans ça, 8 Ko de données de lien occuperaient le pool du loader tant
; que le fichier est indexé.
;*******************************************************************************
