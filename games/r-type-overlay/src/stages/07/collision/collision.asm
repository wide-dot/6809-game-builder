;*******************************************************************************
; La collision terrain du stage 7 — unite paginee, gabarit du stage 1
;
...
; (vérité : le terrain.asm v1 du stage, dans src/stages/07/terrain/).
;
...
lvlMapWidth equ 48 ; stage 07 width (terrain.asm v1)
...
; level7_bc.bin du dossier terrain est un orphelin qu'elle ne
; consomme jamais (son pas de ligne ne correspond d'ailleurs pas).
collisionMapBackground
collisionMapForeground
        INCLUDEBIN "src/stages/07/terrain/level7_fc.bin"
