;*******************************************************************************
; La collision terrain du stage 5 — unite paginee, gabarit du stage 1
;
...
; (vérité : le terrain.asm v1 du stage, dans src/stages/05/terrain/).
;
...
lvlMapWidth equ 48 ; stage 05 width (terrain.asm v1)
...
; level5_bc.bin du dossier terrain est un orphelin qu'elle ne
; consomme jamais (son pas de ligne ne correspond d'ailleurs pas).
collisionMapBackground
collisionMapForeground
        INCLUDEBIN "src/stages/05/terrain/level5_fc.bin"
